        ...
        <div class="col s12 center">
          ...
          <form class="col s12" action="">
              ...
              <div class="row">
                ...
                <div class="input-field col s4">
                 <select onchange="showHint(this.value)">
                    <option value="" disabled selected>Shop Level</option>
               ...
               <div class="input-field col s4">
                    ...
                    <button class="btn waves-effect waves-light" id="shop" type="submit">Search
...
function showHint(str) {
  ...
  xhttp.open("GET", "searchScriptNew.php?q="+str, true);
  xhttp.send();   
}
</script>
